    ...
    data() {
                        ...
                        this.$nextTick(() => {
                            ...
                            if (sessionStorage.getItem('province') === '河南') {
                                ...
                                window.parent.location.href = ''
                                    + 'http://202.99.114.71:40001/hnlthotel/topSkip.html?'
                                    + 'userId=' + userId
                                    + '&carrierId=204&industry=hotel&state=1&categoryid=dc00005224&'
                                    + 'backtovideo=false&returnurl=http%3A%2F%2F'
        ...
        ready() {
            ...
            this.$nextTick(() => {
                ...
                // console.log('indexUrl: ' + sessionStorage.getItem('indexUrl'));
